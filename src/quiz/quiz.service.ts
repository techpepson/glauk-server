...
export class QuizService {
  ...
  async generateQuizFromPDF(
    ...
    try {
      ...
      // create a record of the generated quiz
      // const quizRecord = await this.prisma.courseSlides.create({
      //   data: {
      //     slideUrl: pdfUrl.publicUrl,
      //     courseArea: payload.courseArea,
      //     questions: {
      //       create: {
      //         content:
      //           typeof aIRequest === 'string'
      //             ? aIRequest
      //             : JSON.stringify(aIRequest),
      //         // Ensure we use the Prisma-generated enum type here; cast if needed
      //         questionType:
      //           payload.questionType,
      //         // difficultyLevel is stored as string in Prisma schema
      //         difficultyLevel:
      //           payload.difficultyLevel,
      //         numberOfQuestionsGenerated: payload.numberOfQuestions,
      //         correctAnswer: '',
      //         explanation: '',
      //         options: [] as string[],
      //       },
